...
namespace CE::Vulkan
{
	...
	void Device::InitGpu()
	{
		...
		for (int i = 0; i < deviceExtensionCount; ++i)
		{
			...
			if (strcmp(deviceExtensionProperties[i].extensionName, VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME) == 0)
			{
				deviceExtensionNames.Add(VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME);
			}
