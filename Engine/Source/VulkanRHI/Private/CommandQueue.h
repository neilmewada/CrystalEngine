...
namespace CE::Vulkan
{
    ...
    public:
        ...
        CommandQueue(Device* device, u32 familyIndex, u32 queueIndex, RHI::HardwareQueueClassMask queueMask, RHI::HardwareQueueClass queueClass, VkQueue queue, bool presentSupported);
