...
namespace CE::Vulkan
{
	...
	public:
		...
		MemoryHeap(Device* device, VkDeviceMemory allocation, VkMemoryPropertyFlags memoryPropertyFlags, u32 supportedMemoryTypeBitMask = 0, u32 allocatedMemoryTypeIndex = 0);
