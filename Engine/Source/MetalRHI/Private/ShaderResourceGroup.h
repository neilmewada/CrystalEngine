...
namespace CE::Metal
{
    ...
    public:
        ...
        bool Bind(Name name, u32 firstArrayElement, u32 count, RHI::Sampler** samplers) override;

        bool Bind(u32 imageIndex, Name name, u32 firstArrayElement, u32 count, RHI::Sampler** samplers) override;
