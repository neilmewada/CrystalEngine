...
namespace CE::Editor
{
    static WeakRef<FusionSDFFontAtlasWindow> instance = nullptr;

    FusionSDFFontAtlasWindow::FusionSDFFontAtlasWindow()
    {

    }

    void FusionSDFFontAtlasWindow::Construct()
    {
        Super::Construct();
        ...
        FBrush defaultImage = FBrush(String::Format("__SDFFontAtlas_{}_0", fontNames[0]));
            ...
            .Content(
                ...
                (
                    ...
                    .OnSelectionChanged([this, fontNames, fontAtlases](FComboBox*)
                    {
                        ...
                        FBrush image = FBrush(String::Format("__SDFFontAtlas_{}_0", fontNames[selectionIndex]));
                    ...
                    .OnSelectionChanged([this, fontNames, fontAtlases](FComboBox*)
                    {
                        ...
                        FBrush image = FBrush(String::Format("__SDFFontAtlas_{}_{}", fontNames[fontIndex], page));
                        image.SetBrushTiling(FBrushTiling::None);
                        image.SetImageFit(FImageFit::Cover);
                        image.SetBrushPosition(Vec2(0, 0));
    ...
    void FusionSDFFontAtlasWindow::OnPostComputeLayout()
    {
        Super::OnPostComputeLayout();

    }

    void FusionSDFFontAtlasWindow::OnPaint(FPainter* painter)
    {
    ...
    Ref<FusionSDFFontAtlasWindow> FusionSDFFontAtlasWindow::Show()
    {
        if (Ref<FusionSDFFontAtlasWindow> lock = instance.Lock())
        {
        ...
        Ref<FusionSDFFontAtlasWindow> window = Object::CastTo<FusionSDFFontAtlasWindow>(FusionApplication::Get()->CreateNativeWindow(
            "FusionSDFFontAtlasWindow", 
            "Fusion SDF Font Atlas",
            800, 600,
